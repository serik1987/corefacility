import {
	...
	ServerSideError, NetworkError, RequestTooLongError,
}
...
/** Request too long error code. May be generated by nginx, so the response can be in non-JSON format */
const REQUEST_TOO_LONG_CODE = 413;
...
class HttpClient{
	...
	processErrorResponse(response, poolingFunction, poolNumber){	
		...
		} else if (response.status === REQUEST_TOO_LONG_CODE){
