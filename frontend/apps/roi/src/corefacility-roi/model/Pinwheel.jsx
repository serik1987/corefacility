 ...
 */
export default class Pinwheel extends ChildEntity{
    ...
    static _defineEntityProviders(){
        return [
            new HttpRequestProvider('core/projects/:id:/imaging/processors/:id:/roi/pinwheels', Pinwheel),
        ];
    }
    ...
    static async find(searchParams){
        let result = await super.find(searchParams);
        result.map(pinwheel => pinwheel._state = EntityState.loaded);
        return result;
    }
