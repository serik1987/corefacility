...
from ... import App as CoreApp, AuthorizationsEntryPoint, SynchronizationsEntryPoint, \
    ProjectsEntryPoint
...
from ..data_providers.module_providers import entry_point_provider
from ..data_providers.entity_sets import filter_data_provider
from ..entity.base_apps_test import BaseAppsTest
from ..entity.entity_objects.entry_point_set_object import EntryPointSetObject
