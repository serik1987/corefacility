# Generated by Django 4.2.5 on 2024-09-08 17:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime', models.DateTimeField(db_index=True, help_text='Date and time of the start of event', null=True)),
                ...
                ('parent_category', models.ForeignKey(help_text='Parent category or NULL if root', null=True, on_delete=django.db.models.deletion.RESTRICT, to='core_application.labjournalrecord')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.PositiveSmallIntegerField(help_text='Parameters with a higher index will be displaced below parameters with a lower index', null=True)),
                ...
                ('default', models.CharField(help_text="Default value for the field or NULL if the field doesn't have default field", max_length=256, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(help_text='Category which search parameters are checked by the user', null=True, on_delete=django.db.models.deletion.CASCADE, to='core_application.labjournalrecord')),
                ('project', models.ForeignKey(help_text='Related project', null=True, on_delete=django.db.models.deletion.CASCADE, to='core_application.project')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(help_text='Record where the parameter must be shown or hidden', null=True, on_delete=django.db.models.deletion.CASCADE, to='core_application.labjournalrecord')),
                ...
                ('project', models.ForeignKey(help_text='The related project', on_delete=django.db.models.deletion.CASCADE, to='core_application.project')),
            ...
            options={
                'unique_together': {('project_id', 'category_id', 'user_id', 'descriptor_id')},
            },
        ),
        migrations.CreateModel(
