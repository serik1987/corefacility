from .....entity.readers.external_authorization_token_reader import ExternalAuthorizationTokenReader
from .....entity.readers.model_emulators import ModelEmulator, time_from_db
...
class AuthorizationTokenReader(ExternalAuthorizationTokenReader):
    ...
    def initialize_query_builder(self):
        ...
        self.items_builder\
            .add_select_expression("auth_google_authorizationtoken.access_token")\
            .add_select_expression("auth_google_authorizationtoken.expires_in")\
            .add_select_expression("auth_google_authorizationtoken.refresh_token")
