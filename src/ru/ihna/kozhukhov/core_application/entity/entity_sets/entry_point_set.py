...
from ..entity_sets.entity_set import EntitySet
...
class EntryPointSet(EntitySet):
    ...
    _entity_class = "ru.ihna.kozhukhov.core_application.entity.entry_points.EntryPoint"

    _entity_reader_class = \
        "ru.ihna.kozhukhov.core_application.entity.readers.entry_point_reader.EntryPointReader"

    _entity_filter_list = {
        "parent_module_is_root": (bool, None),
        "parent_module": ("ru.ihna.kozhukhov.core_application.entity.corefacility_module.CorefacilityModule", None),
    }
