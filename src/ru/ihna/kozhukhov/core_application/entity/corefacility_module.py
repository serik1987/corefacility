...
from ru.ihna.kozhukhov.core_application.entity.entity_sets.corefacility_module_set import CorefacilityModuleSet
from .providers.model_providers.corefacility_module_provider import CorefacilityModuleProvider
from .fields import EntityField, ReadOnlyField, ManagedEntityField
from .field_managers.module_settings_manager import ModuleSettingsManager
from ..exceptions.entity_exceptions import ModuleUuidNotGuessedException, \
...
class CorefacilityModule(Entity):
    ...
    def permissions(self, value):
        ...
        """
        from .access_level import AccessLevelSet
        if not self.is_application:
            raise AttributeError("Permissions are not defined at the application level")
