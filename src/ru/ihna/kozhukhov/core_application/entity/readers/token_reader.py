...
class TokenReader(RawSqlQueryReader):
    ...
    def initialize_query_builder(self):
        self.items_builder\
            ...
            .add_select_expression("core_application_user.email")\
            .add_select_expression("core_application_user.phone")\
            .add_select_expression("core_application_user.is_locked")\
            .add_select_expression("core_application_user.is_superuser")\
            .add_select_expression("core_application_user.is_support")\
            .add_select_expression("core_application_user.avatar")\
            .add_select_expression("core_application_user.unix_group")\
            .add_select_expression("core_application_user.home_dir")\
        ...
        self.items_builder.data_source\
            .add_join(self.items_builder.JoinType.INNER, "core_application_user",
                      "ON (core_application_user.id=%s.user_id)" % self._lookup_table_name)
