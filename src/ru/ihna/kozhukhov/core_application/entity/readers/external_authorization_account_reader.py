...
class ExternalAuthorizationAccountReader(RawSqlQueryReader):
    ...
    def initialize_query_builder(self):
        ...
        self.items_builder.data_source.add_join(self.items_builder.JoinType.INNER, "core_application_user",
                                                "ON (core_application_user.id=%s.user_id)" % self.lookup_table_name)
