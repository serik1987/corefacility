...
class ExternalAuthorizationTokenReader(RawSqlQueryReader):
    ...
    def initialize_query_builder(self):
        ...
        self.items_builder\
            ...
            .add_select_expression("core_application_authentication.user_id")\
            .add_data_source(self.lookup_table_name)\
            .add_order_term(self.lookup_table_name + ".id")
        self.items_builder.data_source\
            .add_join(self.items_builder.JoinType.INNER, "core_application_authentication",
                      "ON (core_application_authentication.id=%s.authentication_id)" % self.lookup_table_name)
