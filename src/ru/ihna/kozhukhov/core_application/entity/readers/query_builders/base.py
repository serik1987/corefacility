from ru.ihna.kozhukhov.core_application.exceptions.entity_exceptions \
    import EntityFeatureNotSupported, EntityNotFoundException
from .data_source import SqlTable
