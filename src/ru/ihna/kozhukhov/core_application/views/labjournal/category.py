...
from ru.ihna.kozhukhov.core_application.generic_views import EntityListCreateView
...
from ru.ihna.kozhukhov.core_application.serializers.labjournal import \
    RecordSerializer


date_from_filter_function = EntityListCreateView.date_filter_function('date_from')
date_to_filter_function = EntityListCreateView.date_filter_function('date_to')


class CategoryView(EntityListCreateView):
    """
    ...
    list_filters = {
        'name': EntityListCreateView.standard_filter_function('name', str),
    }
