    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authentication', models.OneToOneField(help_text='Link to the authentication details', null=True, on_delete=django.db.models.deletion.CASCADE, to='core.authentication')),
            ],
        ),
        migrations.CreateModel(
            name='Account',
