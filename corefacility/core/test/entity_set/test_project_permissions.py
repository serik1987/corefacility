...
class TestProjectPermission(BasePermissionsTest):
    ...
    permission_model = models.ProjectPermission
    ...
    def setUp(self):
        ...
        self.level_set.type = LevelType.project_level
    ...
    def get_incorrect_access_level(self):
        """
        Returns the access level that cannot be set

        :return: the AccessLevel entity
        """
        level_set = AccessLevelSet()
        level_set.type = LevelType.app_level
        return level_set.get("add")
