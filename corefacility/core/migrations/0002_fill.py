...
class Migration(migrations.Migration):
    ...
    def set_project_access_levels(AccessLevel):
        ...
        AccessLevel.objects.bulk_create([
            AccessLevel(type=project_permission, alias="full", name="Full access"),
            AccessLevel(type=project_permission, alias="data_full", name="Dealing with data"),
            AccessLevel(type=project_permission, alias="data_add", name="Adding and processing the data"),
            AccessLevel(type=project_permission, alias="data_process", name="Adding the data"),
            AccessLevel(type=project_permission, alias="data_view", name="Viewing the data"),
            AccessLevel(type=project_permission, alias="no_access", name="No access"),
        ])
    ...
    def set_application_access_levels(AccessLevel):
        ...
        AccessLevel.objects.bulk_create([
            AccessLevel(type=app_permission, alias="add", name="Add application"),
            AccessLevel(type=app_permission, alias="permission_required",
                        name="Add application (superuser permission required)"),
    ...
    def create_default_app_tree(Module, EntryPoint):
        ...
        :return: nothing
        """
        core_application = Module(parent_entry_point=None, alias="core", name="Basic facility", html_code=None,
        ...
        authorizations = EntryPoint(alias="authorizations", belonging_module=core_application,
                                    name="Authorization modules", type=EntryPointType.list.value)
        authorizations.save()
        Module(parent_entry_point=authorizations, alias="standard", name="Standard authorization", html_code=None,
               app_class="core.authorizations.StandardAuthorization", is_application=False, is_enabled=True,
               user_settings=dict()).save()
        Module(parent_entry_point=authorizations, alias="ihna", name="Authorization through IHNA website",
        ...
        Module(parent_entry_point=authorizations, alias="google", name="Authorization though Google",
               html_code="<div class='auth google'></div>", app_class="authorizations.google.App", user_settings=dict(),
               is_application=False, is_enabled=False).save()
        Module(parent_entry_point=authorizations, alias="mailru", name="Authorization through Mail.ru",
               html_code="<div class='auth mailru'></div>", app_class="authorizations.mailru.App", user_settings=dict(),
               is_application=False, is_enabled=False).save()
        Module(parent_entry_point=authorizations, alias="unix", name="Authorization through UNIX account",
               html_code=None, app_class="core.authorizations.UnixAuthorization", user_settings=dict(),
               is_application=False, is_enabled=False).save()
        Module(parent_entry_point=authorizations, alias="cookie", name="Authorization through Cookie",
               html_code=None, app_class="authorizations.cookie.App", user_settings=dict(),
               is_application=False, is_enabled=False).save()
        Module(parent_entry_point=authorizations, alias="password_recovery", name="Password recovery function",
               html_code=None, app_class="core.authorizations.PasswordRecoveryAuthorization", user_settings=dict(),
               is_application=False, is_enabled=False).save()
        Module(parent_entry_point=authorizations, alias="auto", name="Automatic authorization",
        ...
        synchronizations = EntryPoint(alias="synchronizations", belonging_module=core_application,
                                      name="Synchronization modules", type=EntryPointType.select.value)
        synchronizations.save()
        Module(parent_entry_point=synchronizations, alias="ihna_employees",
               name="Synchronization with the IHNA website", html_code=None,
               app_class="core.synchronizations.IhnaSynchronization", user_settings=dict(), is_application=False,
               is_enabled=False).save()

        projects = EntryPoint(alias="projects", belonging_module=core_application, name="Project applications",
                              type=EntryPointType.list.value)
        projects.save()
        imaging = Module(parent_entry_point=projects, alias="imaging",
                         name="Basic functional maps processing", html_code=None, app_class="imaging.App",
        ...
        image_processors = EntryPoint(alias="processors", belonging_module=imaging,
                                      name="Imaging processors", type=EntryPointType.list.value)
        image_processors.save()
        Module(parent_entry_point=image_processors, alias="roi", name="ROI definition", html_code=None,
